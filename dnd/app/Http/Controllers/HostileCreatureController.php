    ...
    public function updateHostileCreature(int $id, Request $request): JsonResponse
    {
        ...
        try {
            $hostile->update([
                ...
                'damage_immunities' => $validated['damageImmunities'] ?? $hostile->damageImmunities,
                'condition_immunities' => $validated['conditionImmunities'] ?? $hostile->conditionImmunities,
                'damage_resistance' => $validated['damageResistance'] ?? $hostile->damageResistance,
                'condition_resistance' => $validated['conditionResistance'] ?? $hostile->conditionResistance,
                'characteristics' => $validated['characteristics'] ?? $hostile->characteristics,
